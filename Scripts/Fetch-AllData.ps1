...
Get-ChildItem $ManifestPath -Exclude '*moviemanifest', 'sound*manifest', 'manifest_assetmanifest' | Get-ManifestItem | ForEach-Object { $_ } | ForEach-Object -Parallel {Import-Module $using:PSScriptRoot/Save-RedivePool.psm1; Save-ManifestItem $_}
